    ...
    public static class ServiceCollectionExtension
    {
        ...
        public static void RegisterOtherServices(this IServiceCollection services, IConfiguration configuration)
        {
           ...
           x.UseSqlServer(configuration.GetConnectionString("SpineConnection"))); // reads connection string from config file
            ...
            services.AddMediatR(AppDomain.CurrentDomain.Load("Spine.Core.Customers")); //AppDomain.CurrentDomain.GetAssemblies()
            services.AddAutoMapper(AppDomain.CurrentDomain.Load("Spine.Core.Customers"));  //typeof(CustomerMappingProfile)
            ...
            //var exportEntityTypes = Assembly.GetAssembly(typeof(ExportCustomers.Model)).GetTypes().Where(t => interfaceType.IsAssignableFrom(t));
