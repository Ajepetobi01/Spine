    ...
    public static class ServiceCollectionExtension
    {
        ...
        public static void RegisterOtherServices(this IServiceCollection services, IConfiguration configuration)
        {
           ...
           x.UseSqlServer(configuration.GetConnectionString("SpineConnection"))); // reads connection string from config file
            ...
            services.AddMediatR(AppDomain.CurrentDomain.Load("Spine.Core.Inventory"));
            services.AddAutoMapper(AppDomain.CurrentDomain.Load("Spine.Core.Inventory"));
            ...
            //var exportEntityTypes = Assembly.GetAssembly(typeof(ExportInventory.Model)).GetTypes().Where(t => interfaceType.IsAssignableFrom(t));
