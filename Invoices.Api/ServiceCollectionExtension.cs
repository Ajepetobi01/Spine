    ...
    public static class ServiceCollectionExtension
    {
        ...
        public static void RegisterOtherServices(this IServiceCollection services, IConfiguration configuration)
        {
           ...
           x.UseSqlServer(configuration.GetConnectionString("SpineConnection"))); // reads connection string from config file
            ...
            services.AddScoped<IInvoiceHelper, InvoiceHelper>();
            services.AddScoped<IInvoiceCustomizationHelper, InvoiceCustomizationHelper>();
            ...
            services.AddScoped<IHttpClientFactoryService, ApiCaller>();
            services.AddHttpClient<ApiCaller>();

            services.AddMediatR(AppDomain.CurrentDomain.Load("Spine.Core.Invoices"));
            services.AddAutoMapper(AppDomain.CurrentDomain.Load("Spine.Core.Invoices"));
            ...
            //var exportEntityTypes = Assembly.GetAssembly(typeof(ExportInvoices.Model)).GetTypes().Where(t => interfaceType.IsAssignableFrom(t));
