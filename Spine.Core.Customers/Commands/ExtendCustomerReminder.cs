...
{
    public static class ExtendCustomerReminder
    {
        ...
        public class Handler : IRequestHandler<Command, Response>
        {
            ...
            public async Task<Response> Handle(Command request, CancellationToken token)
            {
                ...
                var reminder = await _dbContext.CustomerReminders.SingleOrDefaultAsync(x => x.CompanyId == request.CompanyId && x.Id == request.Id && !x.IsDeleted);
                ...
                _scheduler.Schedule(new SetCustomerReminderCommand
                {
                    ...
                    , $"Extend Customer Reminder {reminder.Id}");
