...
namespace Spine.Core.Customers.Commands
{
    public static class UpdateCustomerAddress
    {
        ...
        public class Handler : IRequestHandler<Command, Response>
        {
            ...
            {
                var existingItem = await _dbContext.CustomerAddresses.Where(x =>
                ...
                {
                    var others = await _dbContext.CustomerAddresses.Where(x => x.CompanyId == request.CompanyId
               ...
               new AuditModel
               {
                   ...
                   Description = $"Updated customer address of customer with id {request.Id}",
