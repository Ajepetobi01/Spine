...
{
    public static class DeleteVendorAddress
    {
        ...
        public class Handler : IRequestHandler<Command, Response>
        {
            ...
            {
                var address = await _dbContext.VendorAddresses.SingleOrDefaultAsync(x => x.CompanyId == request.CompanyId && x.Id == request.Id && !x.IsDeleted);
                ...
                _auditHelper.SaveAction(_dbContext, request.CompanyId, new AuditModel
                {
                    ...
                    Description = $"Deleted vendor  address"
                });
