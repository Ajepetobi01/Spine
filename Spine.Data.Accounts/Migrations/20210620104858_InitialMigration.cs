        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeCount = table.Column<int>(type: "int", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedTurnOver = table.Column<double>(type: "float", nullable: false),
                    LastTurnOver = table.Column<double>(type: "float", nullable: false),
                    LastProfitBeforeTax = table.Column<double>(type: "float", nullable: false),
                    EstimatedProfitBeforeTax = table.Column<double>(type: "float", nullable: false),
                    LastProfit = table.Column<double>(type: "float", nullable: false),
                    EstimatedProfit = table.Column<double>(type: "float", nullable: false),
                    LastEarningBeforeInterest = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OperatingSector = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BillingAddress = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
