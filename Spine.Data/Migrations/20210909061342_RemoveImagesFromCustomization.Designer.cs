...
namespace Spine.Data.Migrations
{
    ...
    [Migration("20210909061342_RemoveImagesFromCustomization")]
    partial class RemoveImagesFromCustomization
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spine.Data.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.BillsPayments.CableTv", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.BillsPayments.InternetService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.BillsPayments.UtilityService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Inventories.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Inventories.PurchaseOrderReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "PurchaseOrderId", "LineItemId");
            ...
            modelBuilder.Entity("Spine.Data.Entities.InvoiceColorTheme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("346fdc0e-e86c-4d54-94c5-7dffabf76e78"),
                            CreatedOn = new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Name = "Shelob",
                            TextColor = "#001737",
                        ...
                        new
                        {
                            Id = new Guid("6a2c981f-f61f-4bcd-bf94-6a6f540624c7"),
                            CreatedOn = new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Name = "Denethor",
                            TextColor = "#001737",
                        ...
                        new
                        {
                            Id = new Guid("c3ebc501-c3b9-4e70-8fb0-ffe416d6a887"),
                            CreatedOn = new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Name = "Quickbeam",
                            TextColor = "#001737",
                        ...
                        new
                        {
                            Id = new Guid("0b485c5c-e03b-4869-a6bf-5d62164cf74a"),
                            CreatedOn = new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Name = "Shadowfax",
                            TextColor = "#001737",
                        ...
                        new
                        {
                            Id = new Guid("2a4c53af-2148-4401-ba34-3700cde2431e"),
                            CreatedOn = new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Name = "Grima",
                            TextColor = "#001737",
            ...
            modelBuilder.Entity("Spine.Data.Entities.Transactions.SubLedgerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
