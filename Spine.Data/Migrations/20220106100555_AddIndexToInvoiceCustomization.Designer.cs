...
namespace Spine.Data.Migrations
{
    ...
    [Migration("20220106100555_AddIndexToInvoiceCustomization")]
    partial class AddIndexToInvoiceCustomization
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spine.Data.Entities.CompanySerial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LastUsedJournal")
                        .HasColumnType("int");

                    b.Property<int>("LastUsedPO")
                        .HasColumnType("int");

                    b.Property<int>("LastUsedPeriodNo")
                        .HasColumnType("int");

                    b.Property<int>("LastUsedTransactionNo")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Invoices.InvoiceCustomization", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "BannerImageId", "ColorThemeId", "LogoImageId", "SignatureImageId");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Invoices.InvoicePreference", b =>
                {
                    ...
                    b.Property<decimal>("RateToCompanyBaseCurrency")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Transactions.AccountingPeriod", b =>
                {
                    ...
                    b.Property<DateTime?>("BookClosedDate")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("BookClosingId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Transactions.GeneralLedger", b =>
                {
                    ...
                    b.Property<int>("ForexCurrencyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Transactions.JournalPosting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Transactions.OpeningBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spine.Data.Entities.Vendor.VendorPayment", b =>
                {
                    ...
                    b.Property<Guid>("ReceivedGoodItemId")
                        .HasColumnType("uniqueidentifier");
